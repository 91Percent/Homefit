...
<section class="blog-banner-area row1" id="category">
            ...
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">요가</a></li>
     		...
     		<!-- 페이지 바 -->
                      <nav class="blog-pagination justify-content-center d-flex">
                          ...
                          <c:if test="${curpage>BLOCK }">
                              <li class="page-item">
                                  <a href="../ex/yoga.do?page=${startPage-1 }&cate_no=2" class="page-link" aria-label="Previous">
                                    &lt;
                                  </a>
                              </li>
                              </c:if>
                              ...
                              <c:if test="${i==curpage }">
                              <li class="active">
                                  <a href="../ex/yoga.do?page=${i}&cate_no=2 " class="page-link">${i }</a>
                              </li>
                              </c:if>
                              <c:if test="${i!=curpage }">
                              	<li class="page-item">
                              ...
                              <li class="page-item">
                                  <a href="../ex/yoga.do?page=${endPage+1 }&cate_no=2" class="page-link" aria-label="Next">
                                      &gt;
                                  </a>
                              </li>
                            </c:if>
