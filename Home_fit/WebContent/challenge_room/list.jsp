      ...
      <div class="container">
         ...
         <div class="col-xl-9 col-lg-8 col-md-7">
          ...
          <div class=challengebtn>
	          <button type="button" class="button button-subscribe mr-auto mb-1 totalchall" onclick="location.href='../challenge_room/insert.do' ">
	        	전체 도전 목록
	          </button>
	          <button type="button" class="button button-subscribe mr-auto mb-1" onclick="location.href='../challenge_room/insert.do' ">
	        	참여 중인 도전
	          </button>
	          <button type="button" class="button button-subscribe mr-auto mb-1 challinsert" onclick="location.href='../challenge_room/insert.do' ">
	        	도전만들기
	          </button>
          </div>
          <!-- end : 버튼 zone -->
			 ...
			 <c:forEach var="vo" items="${list }">
	          <div class="col-lg-4 col-md-6 mb-4">
			  	<div class="card h-100">
			  																			<!-- 승구야 여기 poster경로 바꿔~! -->
					<a href="../challenge/Certified_detail.do?challenge_no=${vo.challenge_no }"><img class="card-img-top" src="${vo.poster }" width=300px, height=150px>
