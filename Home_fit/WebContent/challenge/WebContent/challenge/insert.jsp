            ...
            <div class="row">
	  		<table class="table table-hover">
			     ...
			     <tr>
			       ...
			       <td width=70%>
			         <input type="text" class="form-control" id="title" name="title" placeholder="방제목을 입력하세요">
			       </td>
			     </tr>
			     ...
			     <tr>
			       ...
			       <td width=70%>
			       		<textarea class="form-control" name="content" id="content" rows="10" placeholder="소개글을 입력하세요"></textarea>
			       </td>
			     </tr>
			     <tr>
